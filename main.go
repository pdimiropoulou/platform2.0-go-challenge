...
func InitializeData() {
	...
	utils.DB.AutoMigrate(&models.User{}, &models.Asset{}, &models.Chart{}, &models.Insight{}, &models.Audience{})
...
func InittializeRouter() {
	...
	router.HandleFunc("/api/assets/charts/{user_id}", chartcontroller.UpdateChart(utils.DB)).Methods("PUT")
	router.HandleFunc("/api/assets/insights/{user_id}", insightcontroller.UpdateInsight(utils.DB)).Methods("PUT")
	router.HandleFunc("/api/assets/audiences/{user_id}", audiencecontroller.UpdateAudience(utils.DB)).Methods("PUT")
